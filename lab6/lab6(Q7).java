...
public class lab6_part2 implements FocusListener{
	JTextField search;
	JFrame frame;
	...
	public void buildTable(String keyword,JPanel panel) {
		...
		try {
			...
			String sql = "Select * From employees Where emp_no like ? ;";
			PreparedStatement pstmt = con.prepareStatement(sql);
			pstmt.setString(1,"%" + (keyword.contentEquals("Search emp_no")? "":keyword) + "%");
